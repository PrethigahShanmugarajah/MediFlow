// MediFlow / Client / src / components / FormField / CheckboxField.jsx
    ...
    <div className={className}>
      ...
      >
        <input
          ...
          className={`rounded border border-indigo-200 text-indigo-600 focus:ring-indigo-200 ${checkboxClassName}`}
