      ...
      <form onSubmit={handleSubmit} className="space-y-5">
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
          <div>
            <InputField
              label={
                <span className="inline-flex items-center gap-2 text-indigo-800">
        ...
        <div className="flex flex-col items-center gap-3">
          <button
            type="submit"
            className="w-full flex items-center gap-2 justify-center bg-indigo-600 text-white px-5 py-2 rounded-full shadow-lg transition-transform active:scale-95"
          >
            {sent ? (
