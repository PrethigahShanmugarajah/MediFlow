              ...
              <div className="flex-1 text-center lg:text-left">
                <div className="flex flex-col lg:flex-row items-center justify-center lg:justify-start mb-4 lg:mb-6 gap-4">
                  <div className="relative">
                    <div className="relative bg-linear-to-br from-blue-300 to-indigo-600 p-3 rounded-full shadow-lg transform -rotate-6 hover:rotate-0 transition-transform duration-300">
                  ...
                  <div className="font-[pacifico]">
                    ...
                    <div className="flex items-center justify-center lg:justify-start mt-1">
                      <div className="flex gap-1">
                        {[1, 2, , 3, 4, 5].map((star) => (
                          <Star
                            className="w-4 h-4 fill-fuchsia-400 text-fuchsia-400"
                            key={star}
                          />
                        ))}
                      </div>
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 mb-6 text-sm sm:text-base">
                  <div className="flex items-center justify-center lg:justify-start bg-linear-to-br from-blue-500 to-blue-200 backdrop-blur-sm p-3 rounded-full shadow-sm border border-blue-100">
                  ...
                  <div className="flex items-center justify-center lg:justify-start bg-linear-to-br from-blue-500 to-blue-200 backdrop-blur-sm p-3 rounded-full shadow-sm border border-violet-100">
                ...
                <div className="flex flex-col sm:flex-row gap-3 sm:gap-4 justify-center lg:justify-start">
                  <button
                    ...
                    className="group relative lg:whitespace-nowrap bg-linear-to-r from-blue-500 to-indigo-500 text-white px-6 py-3 sm:px-8 sm:py-4 rounded-full font-semibold transform transition-all duration-300 shadow-2xl hover:shadow-3xl overflow-hidden text-sm sm:text-base"
                  >
