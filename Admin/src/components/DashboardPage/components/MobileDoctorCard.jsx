// MediFlow / Admin / src / components / DashboardPage / components / MobileDoctorCard.jsx
  ...
  return (
    <div className="bg-white rounded-xl shadow p-3 border border-blue-50">
      <div className="flex items-center justify-between">
        ...
        <div className="text-sm text-slate-700 font-semibold">LKR {d.fee}</div>
      </div>
      ...
      <div className="mt-3 flex items-center justify-between text-sm text-slate-700">
        <div>Earned</div>
        <div className="font-semibold">LKR {d.earnings.toLocaleString()}</div>
      </div>
    </div>
  );
};
