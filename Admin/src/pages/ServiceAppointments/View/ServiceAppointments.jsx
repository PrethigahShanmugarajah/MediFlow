...
import { capitalizeWords, formatDateISO } from "../../../utils/helpers";
...
const ServiceAppointments = () => {
  ...
  const filtered = useMemo(() => {
    return filterServiceAppointments(
      appointments,
      debouncedSearch,
      statusFilter,
    );
        ...
        <DeletePopup
          ...
          description={
            <>
              ...
              <b>{capitalizeWords(selectedCancelAppt.patientName)}</b> on{" "}
              <b>{formatDateISO(selectedCancelAppt.date)}</b> as <b>CANCELED</b>
              ?
            </>
          }
        />
      ...
      {statusPopupOpen && selectedStatusAppt ? (
        <DeletePopup
          ...
          description={
            <>
              Change status for{" "}
              <b>{capitalizeWords(selectedStatusAppt.patientName)}</b> on{" "}
              <b>{formatDateISO(selectedStatusAppt.date)}</b> to{" "}
              <b>{pendingStatus}</b>?
            </>
          }
        />
