// MediFlow / Admin / src / pages / ServiceDashboard / Components / ServiceRowTablet.jsx
    ...
    <div className="hidden md:grid lg:hidden grid-cols-5 items-center gap-6">
      <div className="flex items-center gap-3">
        ...
        <div className="min-w-0">
          ...
          <div className="text-xs text-gray-500">{formatLKR(s.price)}</div>
        </div>
      </div>
      ...
      <div className="text-sm text-center">{formatLKR(earning)}</div>
    </div>
  );
};
